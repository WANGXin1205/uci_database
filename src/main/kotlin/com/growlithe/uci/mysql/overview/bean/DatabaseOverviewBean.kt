package com.growlithe.uci.mysql.overview.bean
 ...
 * @Description 数据集概况
 */
data class DatabaseOverviewBean(
        /**
         * 主键id
         */
        var id:Long ? = null,
    ...
    override fun toString(): String {
        return "DatabaseOverviewBean(id=$id, name=$name, continuityAttributesNumber=$continuityAttributesNumber," +
